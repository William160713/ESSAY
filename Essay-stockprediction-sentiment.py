...
#資料預處理
#以下為lstm
lstmdf = pd.read_csv("C:/Users/user/OneDrive - 國立宜蘭大學/文件/ESSAY\essaydb/output.csv",parse_dates=True,index_col="date")
#df = df[1563:]
...
#以下為lstm+sentiment
df = pd.read_csv("C:/Users/user/OneDrive - 國立宜蘭大學/文件/ESSAY\essaydb/output.csv",parse_dates=True,index_col="date")
#-------------------------------------------------------------------------
...
lstmdtrain_ind = int(0.4*len(lstmdf))
